/**
 * CSAT/NPS seed for Railway DB
 * DATABASE_URL must point to the Railway PostgreSQL instance when running this.
 * Run: npx ts-node --project tsconfig.json prisma/seed-csat-railway.ts
 */
...
const prisma = new PrismaClient({
  datasources: {
    db: {
      url: 'postgresql://postgres:SupwiPDeEuGHlCGKcwhqJHnamWdnpFhi@switchback.proxy.rlwy.net:45927/railway',
    },
  },
});
...
async function main() {
  console.log('🌱 Seeding CSAT/NPS feedback responses → Railway DB…');
